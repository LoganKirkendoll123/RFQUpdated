/*
  ...
  1. New Tables
    ...
    - `verification_codes`
      ...
      - `email` (text)
      - `code` (text)
      - `code_type` (text, check constraint)
  ...
  2. Security
    ...
    - Add policies for user sessions
  ...
  4. Admin Account
    - Create admin user: lkirkendoll@fitzmark.com
...
BEGIN
  ...
  RAISE NOTICE 'Admin account setup completed successfully for lkirkendoll@fitzmark.com';
END $$;