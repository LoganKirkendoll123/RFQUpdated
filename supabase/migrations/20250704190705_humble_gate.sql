/*
  # Fix Carrier Migration with Type Handling

  1. New Features
    - Adds account_code column to carriers table
    - Creates index for account_code
    - Migrates carrier data from CustomerCarriers and Shipments tables
    - Properly handles type conversion for CarrierId field
  
  2. Bug Fixes
    - Fixes type mismatch between text and bigint in COALESCE function
    - Uses explicit type casting with NULL handling
