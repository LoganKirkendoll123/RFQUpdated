/*
  # Fix carrier deletion constraints

  1. Changes
     - Modify foreign key constraints to set carrier_id to NULL on deletion
     - Update Shipments table to use SCAC code for carrier lookup
     - Add comments to document constraint behavior
