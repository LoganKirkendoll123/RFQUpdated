/*
  ...
  1. New Tables
    - `user_profiles`
      ...
      - `email` (text, unique)
      - `first_name`, `last_name`, `company`, `phone` (text)
    ...
    - `user_sessions`
      ...
      - `ip_address` (inet)
      - `user_agent` (text)
      - `expires_at`, `created_at`, `last_activity` (timestamptz)
  ...
  3. Functions
    ...
    - Clean expired codes and sessions
    - Safely create admin account

  4. Admin Account
    - Creates admin user: lkirkendoll@fitzmark.com
    - Password: $Browns2021
    - Role: admin
    - Verified and active
*/
...
BEGIN
  ...
  IF existing_user_id IS NULL THEN
    ...
    RAISE NOTICE 'Created admin user in auth.users with ID: %', admin_user_id;
  ELSE
  ...
  IF existing_profile_id IS NULL THEN
    ...
    RAISE NOTICE 'Created admin profile for lkirkendoll@fitzmark.com';
  ELSE
    ...
    RAISE NOTICE 'Updated existing admin profile for lkirkendoll@fitzmark.com';
  END IF;
